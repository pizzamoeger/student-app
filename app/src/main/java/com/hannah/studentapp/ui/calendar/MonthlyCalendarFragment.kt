...
import com.hannah.studentapp.databinding.FragmentCalendarMonthlyBinding
import com.hannah.studentapp.ui.calendar.CalendarUtils.Companion.daysForCalendarView
import com.hannah.studentapp.ui.calendar.CalendarUtils.Companion.monthYearFromDate
...
class MonthlyCalendarFragment : Fragment() {
    ...
    private fun goToDay() {
        ...
        val action = MonthlyCalendarFragmentDirections.actionFragmentMonthViewToFragmentCalendarDay(fromTimetable = false,date=CalendarUtils.selectedDate.toString())
